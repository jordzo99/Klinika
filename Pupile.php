...
<link rel="stylesheet" href="Pupile.css" media="screen">
    ...
    <section class="u-clearfix u-image u-section-1" id="carousel_2db0" data-image-width="1280" data-image-height="853">
      <div class="u-clearfix u-sheet u-sheet-1">
        <h2 class="u-align-center-xs u-text u-text-body-alt-color u-text-1">Twoje zwierzaki</h2></br>
		<div class="lista-pupili u-text-body-alt-color">     
						...
						$sql = "SELECT id_pupil, imie, rodzaj, nazwa FROM pupil where id_wlasciciela =". $_SESSION['user_id'];
						$result = $conn->query($sql);

						if ($result->num_rows > 0) {
 
							while($row = $result->fetch_assoc()) {
							echo "<strong>Id pupila:</strong> " . $row["id_pupil"] . "<br><strong>Imie:</strong> " . $row["imie"]. "<br><strong>Rodzaj:</strong> " . $row["rodzaj"]. "<br><strong>Gatunek:</strong> " . $row["nazwa"] . "<br><br>";
						}
						} else {
        ...
        <a href="Pupil.php" data-page-id="457100117" class="u-active-none u-border-2 u-border-palette-1-base u-btn u-btn-rectangle u-button-style u-hover-none u-none u-text-body-alt-color u-btn-1">Dodaj pupila</a>
      </div>
    </section>
